...
--
-- Hôte : localhost:3306
-- Généré le :  lun. 02 mars 2020 à 20:08
...
(4, 'Splash', 1, '16.248', NULL, NULL, '2019-10-31 10:56:09', '2024-08-13 10:56:09', 1, 4, NULL),
(5, 'Vivi', 0, '15.455', NULL, NULL, '2020-01-28 10:56:09', '2022-08-03 10:56:09', 1, 5, NULL),
(6, 'Babe', 1, '21.883', NULL, NULL, '2019-09-06 10:56:09', '2024-12-29 10:56:09', 1, 6, NULL),
(7, 'Knack', 1, '10.944', NULL, NULL, '2019-09-05 10:56:09', '2023-02-07 10:56:09', 1, 7, NULL),
(8, 'Titoulatouich', 0, '18.168', NULL, NULL, '2019-09-02 10:56:09', '2022-12-12 10:56:09', 1, 8, NULL);
...
--
ALTER TABLE `pig`
  MODIFY `id_pig` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
